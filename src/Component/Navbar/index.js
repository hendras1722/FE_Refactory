    ...
    const NavbarList = () => {
        switch (props.name) {
                    ...
                    <Fragment>
                        <nav class="navbar navbar-expand-lg navbar-light pr-5 pl-5 navbarnya">
                            <div className="container">
                                <Link class="navbar-brand" to="/"><img alt="logo" src="https://i0.wp.com/refactory.id/wp-content/uploads/2020/01/refactory-hd.png?resize=125%2C52&ssl=1" style={{ width: 80 }} /></Link>
            ...
            case 'blog':
                return (
                    <Fragment>
                        <nav class="navbar navbar-expand-lg navbar-light pr-5 pl-5 navbarBlog">
                            <Link class="navbar-brand" to="/"><img alt="logo" src="https://i0.wp.com/refactory.id/wp-content/uploads/2020/01/refactory-hd.png?resize=125%2C52&ssl=1" /></Link>
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                                <span class="navbar-toggler-icon"></span>
                            </button>
